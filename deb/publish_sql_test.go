...
type PublishedRepoSQLSuite struct {
...
var _ = Suite(&PublishedRepoSQLSuite{})

func (s *PublishedRepoSQLSuite) SetUpTest(c *C) {
	s.SetUpPackages()
...
func (s *PublishedRepoSQLSuite) TearDownTest(c *C) {
	s.db.Close()
}

func (s *PublishedRepoSQLSuite) TestNewPublishedRepo(c *C) {
...
func (s *PublishedRepoSQLSuite) TestPrefixNormalization(c *C) {
...
func (s *PublishedRepoSQLSuite) TestDistributionComponentGuessing(c *C) {
...
func (s *PublishedRepoSQLSuite) TestPublish(c *C) {
...
func (s *PublishedRepoSQLSuite) TestPublishNoSigner(c *C) {
...
func (s *PublishedRepoSQLSuite) TestPublishLocalRepo(c *C) {
...
func (s *PublishedRepoSQLSuite) TestPublishLocalSourceRepo(c *C) {
...
func (s *PublishedRepoSQLSuite) TestPublishOtherStorage(c *C) {
...
func (s *PublishedRepoSQLSuite) TestString(c *C) {
...
type PublishedRepoCollectionSQLSuite struct {
	PackageListMixinSuite
	db                                database.Storage
	factory                           *CollectionFactory
...
var _ = Suite(&PublishedRepoCollectionSQLSuite{})

func (s *PublishedRepoCollectionSQLSuite) SetUpTest(c *C) {
	s.driverName = "sqlite3"
	s.dataSourceName = fmt.Sprintf("file:%s/sql_test.db", c.MkDir())
	s.tableName = "testtable"
	s.db, _ = sql.NewOpenDB(s.driverName, s.dataSourceName, s.tableName)
...
func (s *PublishedRepoCollectionSQLSuite) TearDownTest(c *C) {
	s.db.Close()
}

func (s *PublishedRepoCollectionSQLSuite) TestAddByStoragePrefixDistribution(c *C) {
...
func (s *PublishedRepoCollectionSQLSuite) TestByUUID(c *C) {
...
func (s *PublishedRepoCollectionSQLSuite) TestUpdateLoadComplete(c *C) {
...
/*
func (s *PublishedRepoCollectionSQLSuite) TestLoadPre0_6(c *C) {
...
func (s *PublishedRepoCollectionSQLSuite) TestForEachAndLen(c *C) {
...
func (s *PublishedRepoCollectionSQLSuite) TestBySnapshot(c *C) {
...
func (s *PublishedRepoCollectionSQLSuite) TestByLocalRepo(c *C) {
	c.Check(s.collection.Add(s.repo1), IsNil)
...
type PublishedRepoRemoveSQLSuite struct {
	PackageListMixinSuite
	db                                  database.Storage
	factory                             *CollectionFactory
	snapshotCollection                  *SnapshotCollection
...
var _ = Suite(&PublishedRepoRemoveSQLSuite{})

func (s *PublishedRepoRemoveSQLSuite) SetUpTest(c *C) {
	s.driverName = "sqlite3"
	s.dataSourceName = fmt.Sprintf("file:%s/sql_test.db", c.MkDir())
	s.tableName = "testtable"
	s.db, _ = sql.NewOpenDB(s.driverName, s.dataSourceName, s.tableName)
...
func (s *PublishedRepoRemoveSQLSuite) TearDownTest(c *C) {
	s.db.Close()
}

func (s *PublishedRepoRemoveSQLSuite) TestRemoveFilesOnlyDist(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveFilesWithPool(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveFilesWithTwoPools(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveFilesWithPrefix(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveFilesWithPrefixRoot(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveRepo1and2(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveRepo1and2SkipCleanup(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveRepo3(c *C) {
...
func (s *PublishedRepoRemoveSQLSuite) TestRemoveRepo5(c *C) {
