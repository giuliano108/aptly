...
type SnapshotSuiteSQL struct {
	PackageListMixinSuite
	repo *RemoteRepo
}

var _ = Suite(&SnapshotSuiteSQL{})

func (s *SnapshotSuiteSQL) SetUpTest(c *C) {
	s.SetUpPackages()
...
func (s *SnapshotSuiteSQL) TestNewSnapshotFromRepository(c *C) {
...
func (s *SnapshotSuiteSQL) TestNewSnapshotFromLocalRepo(c *C) {
...
func (s *SnapshotSuiteSQL) TestNewSnapshotFromPackageList(c *C) {
...
func (s *SnapshotSuiteSQL) TestNewSnapshotFromRefList(c *C) {
	snap, _ := NewSnapshotFromRepository("snap1", s.repo)
...
func (s *SnapshotSuiteSQL) TestKey(c *C) {
	snapshot, _ := NewSnapshotFromRepository("snap1", s.repo)
	c.Assert(len(snapshot.Key()), Equals, 37)
	c.Assert(snapshot.Key()[0], Equals, byte('S'))
}

func (s *SnapshotSuiteSQL) TestRefKey(c *C) {
	snapshot, _ := NewSnapshotFromRepository("snap1", s.repo)
...
func (s *SnapshotSuiteSQL) TestEncodeDecode(c *C) {
	snapshot, _ := NewSnapshotFromRepository("snap1", s.repo)
	s.repo.packageRefs = s.reflist
...
type SnapshotCollectionSuiteSQL struct {
	PackageListMixinSuite
	db                   database.Storage
...
var _ = Suite(&SnapshotCollectionSuiteSQL{})

func (s *SnapshotCollectionSuiteSQL) SetUpTest(c *C) {
	driverName := "sqlite3"
...
func (s *SnapshotCollectionSuiteSQL) TearDownTest(c *C) {
	s.db.Close()
}

func (s *SnapshotCollectionSuiteSQL) TestAddByNameByUUID(c *C) {
...
func (s *SnapshotCollectionSuiteSQL) TestUpdateLoadComplete(c *C) {
...
func (s *SnapshotCollectionSuiteSQL) TestForEachAndLen(c *C) {
...
func (s *SnapshotCollectionSuiteSQL) TestForEachSorted(c *C) {
	s.collection.Add(s.snapshot2)
	s.collection.Add(s.snapshot1)
...
func (s *SnapshotCollectionSuiteSQL) TestFindByRemoteRepoSource(c *C) {
	c.Assert(s.collection.Add(s.snapshot1), IsNil)
	c.Assert(s.collection.Add(s.snapshot2), IsNil)
...
func (s *SnapshotCollectionSuiteSQL) TestFindByLocalRepoSource(c *C) {
	c.Assert(s.collection.Add(s.snapshot1), IsNil)
	c.Assert(s.collection.Add(s.snapshot2), IsNil)
...
func (s *SnapshotCollectionSuiteSQL) TestFindSnapshotSource(c *C) {
...
func (s *SnapshotCollectionSuiteSQL) TestDrop(c *C) {
	s.collection.Add(s.snapshot1)
	s.collection.Add(s.snapshot2)
